...
class LightSAT4JSolverSuite extends FunSuite {
  ...
  def testLightSat4JSolver(): Unit = {
    ...
    //fpsec2
    val failureSpec2 = FailureSpec(2, 2, 1, nodes, msgs, Set.empty, Set.empty)
    ...
    //fpsec3
    val failureSpec3 = FailureSpec(2, 1, 0, nodes, msgs, Set.empty, Set.empty)
    ...
    //fpsec4
    val failureSpec4 = FailureSpec(2, 1, 1, nodes, msgs, Set.empty, Set.empty)
    ...
    //fpsec5
    val failureSpec5 = FailureSpec(2, 0, 0, nodes, msgs, Set.empty, Set.empty)
    ...
    //fpsec6
    val failureSpec6 = FailureSpec(2, 0, 1, nodes, msgs, Set.empty, Set.empty)
    ...
    //fpsec7
    val failureSpec7 = FailureSpec(2, 2, 0, nodes, msgs, Set(Node("A", 1)), Set.empty)
    ...
    //fpsec8
    val failureSpec8 = FailureSpec(2, 2, 1, nodes, msgs, Set(Node("A", 1)), Set.empty)
    ...
    //fpsec9
    val failureSpec9 = FailureSpec(2, 2, 1, nodes, msgs, Set(node1), Set(msg1))
    ...
    //fpsec10
    val failureSpec10 = FailureSpec(2, 2, 1, nodes, msgs, Set(node1, node2, node3), Set(msg1, msg2))
